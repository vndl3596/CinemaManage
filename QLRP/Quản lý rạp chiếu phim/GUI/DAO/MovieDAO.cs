...
namespace GUI.DAO
{
    public class MovieDAO
    {
        ...
        public static DataTable SearchMovieByID(String id)
        {
            return DataProvider.ExecuteQuery("SELECT * FROM dbo.Phim WHERE id = '" + id + "'");
        }

        public static DataTable SearchStartDay( String idDinhDang)
        {
            return DataProvider.ExecuteQuery("SELECT Phim.NgayKhoiChieu FROM dbo.Phim, dbo.DinhDangPhim WHERE DinhDangPhim.id = '" + idDinhDang + "' AND DinhDangPhim.idPhim = Phim.id");
        }

        public static DataTable SearchEndDay( String idDinhDang)
        {
            return DataProvider.ExecuteQuery("SELECT Phim.NgayKetThuc FROM dbo.Phim, dbo.DinhDangPhim WHERE DinhDangPhim.id = '" + idDinhDang + "' AND DinhDangPhim.idPhim = Phim.id");
        }

        public static DataTable SearchStartDay()
        {
            return DataProvider.ExecuteQuery("SELECT Phim.id, Phim.NgayKhoiChieu FROM dbo.Phim, dbo.DinhDangPhim WHERE DinhDangPhim.idPhim = Phim.id");
        }

        public static DataTable SearchEndDay()
        {
            return DataProvider.ExecuteQuery("SELECT Phim.id, Phim.NgayKetThuc FROM dbo.Phim, dbo.DinhDangPhim WHERE DinhDangPhim.idPhim = Phim.id");
        }

        public static DataTable SearchMovieUsingInFormatMovie(String id)
        {
            return DataProvider.ExecuteQuery("SELECT * FROM dbo.DinhDangPhim WHERE idPhim = '" + id + "'");
        }
    }
}
