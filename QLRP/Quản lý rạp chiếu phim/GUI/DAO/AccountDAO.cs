...
namespace GUI.DAO
{
    public class AccountDAO
    {
        ...
        public static DataTable SearchAccountByUserName(String user)
        {
            return DataProvider.ExecuteQuery("SELECT * FROM dbo.TaiKhoan WHERE UserName = '" + user + "'");
        }
        public static DataTable SearchAccountByID(String id)
        {
            return DataProvider.ExecuteQuery("SELECT LoaiTK FROM dbo.TaiKhoan WHERE idNV = '" + id + "'");
        }
        public static DataTable SearchAccountTypeByUserName(String username)
        {
            return DataProvider.ExecuteQuery("SELECT LoaiTK FROM dbo.TaiKhoan WHERE UserName = '" + username + "'");
        }
    }
}
